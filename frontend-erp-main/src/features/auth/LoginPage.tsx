 ...
 * Includes user ID/password form and login API integration.
 */
...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login({ userId, password }); // Call login API
      ...
      <div className='relative z-10 w-full max-w-110 px-6 animate-fade-in'>
        ...
        <div className='bg-white/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/50 p-8 md:p-10 ring-1 ring-gray-900/5'>
          ...
          <div className='text-center mb-10'>
            ...
            <p className='mt-3 text-gray-500 text-sm font-medium'>Sign in to your ERP system and start working</p>
          </div>
